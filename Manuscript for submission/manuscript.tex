...
In this section, we focus on investigating the behaviour of non-asymptotic error bound of our estimator in the context where the sample size is fixed as 1, and the number of variables in model is explicitly tracked.
...
\[
    e^{2}(\hat{\alpha}\mathbbm{1}\mathbbm{1}^T,\widehat{L},\widehat{S}):=\|\widehat{\Delta}^{\alpha\mathbbm{1}\mathbbm{1}^T}\|_{F}^{2} + \|\widehat{\Delta}^{L}\|_{F}^{2} + \|\widehat{\Delta}^{S}\|_{F}^{2}
\]
...
&\leq \frac{\delta}{2}(n\|\hat{\Delta}^{\alpha}\|_{F} + \|\widehat{\Delta}^{L}_{A}\|_\ast + \|\widehat{\Delta}^{L}_{B}\|_\ast) + \frac{\gamma}{2}(\|\widehat{\Delta}^{S}_{M}\|_{1} + 
\|\hat{\Delta}^{S}_{M^{\perp}}\|_{1}) \\ 
&= \frac{\delta}{2}n\|\hat{\Delta}^{\alpha}\|_{F} +     \frac{\delta}{2}\mathbb{Q}(\hat{\Delta}^L_{A},\hat{\Delta}^S_{M}) + \frac{\delta}{2}\mathbb{Q}(\hat{\Delta}^L_{B},\hat{\Delta}^S_{M^\perp})  \label{eq:10}
\end{align}
...
\begin{equation}
    \frac{\tau}{2}\|\widehat{\Delta}^{\Theta}\|_{F}^{2} \leq
    \frac{\delta}{2}n\|\hat{\Delta}^{\alpha}\|_{F} + 
...
2 \langle\, \widehat\Delta^{L} + \widehat\Delta^{S} ,\hat{\Delta}^{\alpha}\mathbbm{1}\mathbbm{1}^T \rangle\ +
2 \langle\, \widehat\Delta^{L}, \widehat\Delta^{S} \rangle\ \\ 
&= n^{2}\|\hat{\Delta}^{\alpha}\|_{F}^{2} + \|\widehat{\Delta}^{L}\|_{F}^{2} + \|\widehat{\Delta}^{S}\|_{F}^{2} + 
2 \langle\, \widehat\Delta^{L} + \widehat\Delta^{S} ,\hat{\Delta}^{\alpha}\mathbbm{1}\mathbbm{1}^T \rangle\ +
...
\begin{align}
    ...
    &\geq \frac{\tau}{2} n^{2} \|\hat{\Delta}^{\alpha}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{L}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{S}\|_{F}^{2} 
    - 2\kappa\tau(\frac{Cn+1}{n})\|\widehat{\Delta}^{S}\|_{1} \\ \nonumber
    &\geq \frac{\tau}{2} n^{2} \|\hat{\Delta}^{\alpha}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{L}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{S}\|_{F}^{2} - \frac{\gamma}{2}\|\widehat{\Delta}^{S}\|_{1}\\
    &\geq \frac{\tau}{2} n^{2} \|\hat{\Delta}^{\alpha}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{L}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{S}\|_{F}^{2} - \frac{\delta}{2} \mathbb{Q}(\widehat{\Delta}^L,\widehat{\Delta}^S) \label{eq:26}
\end{align}
...
\[
    \frac{\tau}{2} n^{2} \|\hat{\Delta}^{\alpha}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{L}\|_{F}^{2} + \frac{\tau}{2} \|\widehat{\Delta}^{S}\|_{F}^{2} \\
    \leq \frac{\delta}{2} n \|\hat{\Delta}^{\alpha}\|_{F} + 
...
\begin{align*}
    ...
    \leq \sqrt{2k}\delta\|\widehat{\Delta}^L\|_{F} + \Psi(\mathbb{M})\gamma\|\widehat{\Delta}^S\|_{F} 
\end{align*}

Substituting the above inequality into equation ($\ref{eq:42}$) and rearranging the term relevant with  $e^{2}(\hat{\alpha}\mathbbm{1}\mathbbm{1}^T,\widehat{L},\widehat{S})$ yields the claim.
\end{proof}
