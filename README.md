...
- **Main functions**
    1. [ADMM_Optim.R](https://github.com/namjoonsuh/Citation-Network/blob/master/Codes%20%26%20Data/Codes/ADMM_Optim.R) : Main function for making inference for model parameters. Take adjacency matrix and tuning parameters of models (gamma,delta) as input parameters. 
$`\sqrt{2}`$
```math
